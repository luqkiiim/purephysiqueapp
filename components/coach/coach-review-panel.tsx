      ...
      <section className="grid gap-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Photo counts and latest log timing by client, so visual review does not disappear
              behind the roster.
            </CardDescription>
          </CardHeader>
          <CardContent className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {data.photoIndicators.length ? (
              data.photoIndicators.map((client) => (
                <Link
                  key={client.id}
                  href={`/coach/clients/${client.id}`}
              ...
              <div className="surface-muted p-5 text-sm text-slate-700 md:col-span-2 xl:col-span-3">
